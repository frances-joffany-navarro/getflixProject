  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex my-2 " id="searchBar">      
        <input class="form-control me-2" type="search" id="myInput" value="<?php echo !empty($_GET['search']) ? $_GET['search'] : NULL; ?>" placeholder="Search title/category" aria-label="Recipient's username">
        <button class="btn btn-outline-success me-2" type="button" name="submit" id="button-addon2">Search</button>
      </form>
